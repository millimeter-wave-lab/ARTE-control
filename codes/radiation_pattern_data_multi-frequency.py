...
#Select the frequencies to trigger a tone from the generator.
...
if __name__ == '__main__':
    ...
    for i in range(5):
        ...
        time.sleep(1)
        plot_beam(roach) #To check the correct performance of the generator
        angle=120 #Select the angle of the antenna that you want to save 
        freqname=i
        N = 1000 #Number of measures in each frequency
