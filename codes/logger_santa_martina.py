...
def receive_10gbe_data(folder, file_time,total_time=None,ip_addr='192.168.2.10',
        port=1234, roach_ip='192.168.1.77', DMs = [45,90,135,180,225,270,315,360,405,450,495],
        dram_dump=False,dram_addr=('10.0.0.29',1234), dram_frames=10,cal_time=1, temp=True,
        temp_time=30, rigol_ip='192.168.0.38',first_amp_params=[1,3,0.354], lna_params=[3,5,1.2]):
