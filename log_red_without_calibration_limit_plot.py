...
def plot_folder(folder_name, log_per_img=1, cal_time=1, file_time=5,spect_time=1e-2, plot_misc=True, decimation=1, mov_avg_size=32, tails=32, img_folder="log_img",plot_clip=True,plot_antenna=True):
    """
    ...
    for i in range(n_img):
        ...
        axes[0].axis(ymin = 214000, ymax = 216500)
        axes[0].grid()
