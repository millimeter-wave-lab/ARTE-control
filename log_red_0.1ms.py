...
parser.add_argument("-st", "--spect_time", dest="spect_time", default=1e-4)
...
def get_image_data_temperature(filenames,cal_time=2,spect_time=1e-4,file_time=5 ,decimation=1,
    ...
    data_new/= np.std(data_new[1:,:],axis=0) #100 for 10ms of integration
...
def plot_folder(folder_name, log_per_img=1, cal_time=2, file_time=5,spect_time=1e-4, plot_misc=True, decimation=1, mov_avg_size=32, tails=32, img_folder="log_img",plot_clip=True,plot_antenna=True):
    """
